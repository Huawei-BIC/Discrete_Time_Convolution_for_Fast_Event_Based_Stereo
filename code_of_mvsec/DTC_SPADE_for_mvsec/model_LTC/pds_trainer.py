...
class PdsTrainer(trainer.Trainer):
    ...
    def _compute_gradients_wrt_loss(self, batch):
        ...
        # print("batch['network_output'],batch[left][disparity]", batch['network_output'].size(), batch['left']['disparity_image'].size()) similarity[2,32,260,346] gt[2,260,346] 2 is batch_size
