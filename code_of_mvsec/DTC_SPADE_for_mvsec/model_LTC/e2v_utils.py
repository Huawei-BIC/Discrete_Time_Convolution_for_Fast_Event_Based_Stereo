...
import torchvision
from model_LTC.spynet import run as spynet
import math
...
class VGG19(nn.Module):
    def __init__(self, requires_grad=False):
        super().__init__()
        vgg_pretrained_features = torchvision.models.vgg19(pretrained=False).features
...
class LossFn:
    ...
    def loss(self, pred, y):
        ...
        return pixel_loss + ssim_loss + features_loss + style_loss, features_loss, ssim_loss
