...
from model_LTC.deform_conv import DeformConv, ModulatedDeformConv
...
class DeformBottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.conv2 = DeformConv2d(width, width, stride=stride, dilation=1, padding=1)
...
class DeformSimpleBottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.conv2 = DeformConv2d(width, width, stride=stride,
                                  ...
                                  double_mask=double_mask,padding=padding)
        self.bn2 = norm_layer(width)
        self.conv3 = conv1x1(width, planes)
        self.bn3 = norm_layer(planes)
        self.relu = nn.ReLU(inplace=True)
