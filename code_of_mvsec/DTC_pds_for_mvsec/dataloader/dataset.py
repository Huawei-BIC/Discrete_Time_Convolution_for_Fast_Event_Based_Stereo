...
import torch
from dataloader import dataset_constants
...
class MvsecDataset():
    def __init__(self, examples, dataset_folder, data_hparams, transformers_list=True):
    ...
    def get_example(self, index):
        ...
        return {
            'left': {
                ...
                left_event_queue,
                'disparity_image':
                self._get_disparity_image_queue(example['disparity_image_path'], example['experiment_number'], example['frame_index']),
            },
            'right': {
    ...
    @classmethod
    def dataset(cls, dataset_folder, experiments, data_hparams, frames_filter=None):
        ...
        return cls(examples, dataset_folder, data_hparams)
